...
class Slider {
	...
	initSlider({ btnNext = null, btnPrev = null, containerSlider, slider, item, itemLength }) {
		...
		// Установка обработчика события, когда документ полностью загружен, если событие не происходит то нужно вызвать вручную  handleDOMLoaded(при например pop-up)
...
console.log($totalStep, $stepSlide, 'slider28');
